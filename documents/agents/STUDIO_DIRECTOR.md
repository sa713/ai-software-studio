...
- выбор Operating Profile: Light, Standard or Deep;
...
- соблюдение `MANIFEST.md`, `LIFECYCLE.md`, `ARTIFACTS.md`, `AGENTS.md`, `DECISION_AUTHORITY.md`, `OPERATING_PROFILES.md`;
...
- создание или обновление Mission Index, если создаётся, завершается или архивируется Mission;
...
Перед запуском Mission Mode Studio Director обязан выбрать Mission Operating Profile:

- `Mission Light`;
- `Mission Standard`;
- `Mission Deep`.

Если профиль не указан, действует `Mission Standard`.
...
- указать autonomy level, Operating Profile, allowed scope, Typed Budget and stop conditions в `MISSION_RUN.md`;
- проверить, что выбранный autonomy level разрешён для данной Mission;
- проверить, что выбранный Operating Profile соответствует риску и масштабу Mission;
...
Studio Director не должен использовать Full Mission как routine mode. Для масштабируемой работы по нескольким задачам предпочтителен Bounded Multi-Cycle Mission с ограниченным Typed Budget.
