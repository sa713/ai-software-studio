...
- фиксировать выбранный Operating Profile;
...
- выборе или изменении Operating Profile;
- завершении этапа;
...
Project State может ссылаться на Mission Index, но не должен копировать список миссий. Mission Index хранит только navigation pointers and statuses для множества Mission.
...
Текущий профиль глубины работы.
...
Если поле отсутствует, действует `Standard`.

Operating Profile выбирает Studio Director по `OPERATING_PROFILES.md`.

Operating Profile не меняет Current Stage и не отменяет Source Of Work, Validation, Product Owner Review или stop conditions.
